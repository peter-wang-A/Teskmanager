    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {!! Form::model($project, ['route' => ['projects.update', $project->id], 'method' => 'PATCH', 'files' =>
                'true']) !!}
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        {!! $errors->getBag('update-' . $project->id)->first('name', '<div
                            class="alert alert-danger my-2">:message</div>') !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! $errors->getBag('update-' . $project->id)->first('thumbnail', '<div
                            class="alert alert-danger my-2">:message</div>') !!}
                    </div>
